...
CALIB_DIR="${PROJECT_DIR}/YOLOv11n_INT8/calibration"
SRC_PARAM="${PROJECT_DIR}/YOLOv11n_FP16/yolov11n.param"
SRC_BIN="${PROJECT_DIR}/YOLOv11n_FP16/yolov11n.bin"
OUT_PARAM="${PROJECT_DIR}/YOLOv11n_INT8/yolov11n.param"
OUT_BIN="${PROJECT_DIR}/YOLOv11n_INT8/yolov11n.bin"
TABLE="${PROJECT_DIR}/YOLOv11n_INT8/yolov11n.table"
...
rm -rf build-arm
./build.sh
cp build-arm/detect YOLOv11n_INT8/
